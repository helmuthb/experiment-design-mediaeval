...
The activations that we created with prepare\_subtask2.py produced output which we were able to prepare\_subtask2 into the tartarus code and into our train-subtask2.py.
